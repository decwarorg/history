...
Many links found googling "dp10 dungeon daglow source" including an ita note in github
...
The reason I'm inquiring about it here is in hope that some of the many PDP-10 and DECUS experts on this list can help clarify the situation on exactly which DECUS tapes this game might have been included on. A good summary of things can be found in this post from someone who actually played it back then, from a small thread about the game from nearly 20 years ago:
...
As you can see (and has been repeated elsewhere about the game), it seems that it didn't receive nearly as wide a distribution through DECUS as Daglow's Star Trek, mostly due to size and complexity, which would have made it something of a resource hog. Still, it obviously did make it out there to some extent, so I find it a bit puzzling that it's never been located on any surviving DECUS tape, especially since it appears to have been made available for at least several years, well into the late '70s and possibly beyond.

Any opinions/memories about this, or thoughts about the possibility that it could still be hidden away somewhere on a surviving tape, would be greatly appreciated.
